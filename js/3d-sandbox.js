...
var sShoutoutName = "DronesoundTV"; // Disused
...
var oMoon, fMoonRotXDeg, fMoonRotYDeg;
...
var oGlobalText = "DronesoundTV", fontWeight = "bold";

// Lights
var oAmbientLight, oCamLight;
...
function fnMakeSky (argPrefix) {
  ...
  var imagePrefix = "/mod_sandbox/images/skyboxes/skyblue/skyblue_";

  if (argPrefix.length) {           // Optional new syntax
    imagePrefix = "/mod_sandbox/images/skyboxes/" 
